...
{
    public class ProvinciaRepository : Repository
    {
        public ProvinciaRepository(AppDbContext dbContext, IConfiguration configuration, RepositoryResult result) : base(dbContext, configuration, result)
        {
        }

        public async Task AddAsync(Provincia model)
        {
            try
            {
        ...
        public void Update(Provincia model)
        {
            try
            {
        ...
        public async Task<object> FindByIdAsync(int id)
        {
            ...
            try
            {
                obj = await _db.Provincias.FindAsync(id);
            }
            catch (System.Exception ex)
            {
                _result.Errors.Add("No fue posible realizar la operacion");
